        ...
        <div className="space-y-6 pb-12">
            ...
            {loading ? (
                ...
                <div className="bg-white rounded-xl border border-gray-100 shadow-sm text-center py-16 px-6">
                    <div className="w-16 h-16 bg-violet-50 rounded-xl flex items-center justify-center mx-auto mb-4">
                    ...
                    <Link to="/administration/new" className="inline-flex items-center gap-2 bg-primary text-black px-5 py-2.5 rounded-xl font-medium hover:bg-primary-dark transition-all shadow-sm">
                        Ajouter un membre
                    </Link>
                </div>
            ) : (
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {members.map((admin) => (
                        <div key={admin.id} className="bg-white rounded-xl border border-gray-100 shadow-sm p-5 hover:shadow-md transition-all">
                            <div className="flex items-start gap-3">
                                {/* Avatar */}
                                <div className="w-12 h-12 rounded-xl bg-primary text-black flex items-center justify-center font-bold text-lg flex-shrink-0 shadow-sm">
                            ...
                            <div className="flex items-center gap-2 mt-4 pt-4 border-t border-gray-50">
                                <button
                                    ...
                                    className="flex-1 py-1.5 text-xs font-medium text-gray-600 border border-gray-200 rounded-xl hover:border-primary hover:text-primary hover:bg-primary/5 transition-all"
                                >
                                    Modifier
                                </button>
                                <button
                                    onClick={() => handleDelete(admin.id)}
                                    className="flex-1 py-1.5 text-xs font-medium text-red-500 border border-red-100 rounded-xl hover:bg-red-50 transition-all"
                                >
                                    Retirer
                                </button>
                            </div>
