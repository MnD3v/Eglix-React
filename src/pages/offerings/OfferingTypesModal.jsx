                                    ...
                                    {editingType?.id === type.id ? (
                                        <form onSubmit={handleUpdate} className="flex-1 flex gap-2 mr-2">
                                            <input
                                                ...
                                                className="flex-1 px-3 py-1.5 rounded-lg border border-primary/30 ring-2 ring-primary/10 text-sm"
                                            />
                                            <button type="submit" className="p-1.5 text-primary hover:bg-primary/10 rounded-lg">
                                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                                            </button>
                                            <button type="button" onClick={() => setEditingType(null)} className="p-1.5 text-gray-400 hover:bg-gray-200 rounded-lg">
